  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-md px-6 py-16">
        ...
        {err && <div className="mt-6 rounded-2xl border border-red-500/20 bg-red-500/10 p-4 text-sm text-red-200">{err}</div>}
        ...
        <div className="mt-8 space-y-3 rounded-3xl border border-white/10 bg-white/[0.03] p-6">
          ...
          <a className="block text-center text-xs text-white/60 hover:text-white" href="/auth/signup">
